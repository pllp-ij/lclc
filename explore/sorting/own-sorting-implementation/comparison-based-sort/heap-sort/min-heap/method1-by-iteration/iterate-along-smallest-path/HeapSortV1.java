...
/*
    ...
    DESCRIPTION:
        ...
        Iterate idxHeapRangeEnd from (nums.length - 1) to 1
            ...
            STEP 3
            Swap first smallest element with the last element of each iterated heap range
        ...
        Iterate idxParentNodeStart from idxParentNodeEnd to 0
            STEP 3
            Adjust range from idxParentNodeStart to idxParentNodeEnd by calling recursive method heapifyCore
        ...
        STEP 7
        If idxRightChild <= idxHeapRangeEnd and nums[idxSmallest] > nums[idxRightChild], (meaning right child exist within valid range and its value is less than last smallest element)
            STEP 8
            Update idxSmallest to idxRightChild
                idxSmallest = idxRightChild;
        STEP 9
        If idxSmallest != idxParentNode, (meaning a swap needed)
            STEP 10
            Swap two elements at idxParentNode and idxSmallest
                swap(nums, idxParentNode, idxSmallest);
            STEP 11
            Recursively process next index with value of idxSmallest
