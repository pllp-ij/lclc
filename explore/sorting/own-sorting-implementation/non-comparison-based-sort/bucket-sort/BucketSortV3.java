...
/*
    NOTE:
        Compared to V1 and V2, V3 only update the idxBucketToPlace first to make the insertion of element operation uniformly
    VARS:
    ...
    DESCRIPTION:
        ...
        Iterate each index of nums with idx
            ...
            If idxBucketToPlace == bucketsNum, (meaning current element is the maximum element, directly put it into last bucket)
                STEP 10
                Decrease idxBucketToPlace by one to put current nums[idx] into last bucket
                    idxBucketToPlace--;
            STEP 11
