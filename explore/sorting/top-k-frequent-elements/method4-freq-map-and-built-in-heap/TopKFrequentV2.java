...
/*
    ...
    DESCRIPTION:
        ...
        Iterate each entry of hashValToFreq with Map.Entry<Integer, Integer> valFreqPair
            ...
            STEP 6
            If minHeap.size() > k, (meaning the maintained size of min heap is larger than k)
                STEP 7
                Dequeue one entry from minHeap to keep the number of min heap equal to k at last
                    minHeap.poll();
