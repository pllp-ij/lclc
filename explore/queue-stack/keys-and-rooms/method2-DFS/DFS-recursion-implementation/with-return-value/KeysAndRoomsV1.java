...
/*
    ...
    DESCRIPTION:
        ...
        STEP 1
        If isNotValid(curIndex, visited), (meaning current index is not valid)
            STEP 2
            Return 0 to indicate something returned from deadend
                return 0;
        STEP 3
        ...
        -FUNC boolean isNotValid(int index, Set<Integer> visited)
        STEP 1
        If visited.contains(index), (meaning current node is already in visited)
            STEP 2
            Return true;
        STEP 3
        Return false;
