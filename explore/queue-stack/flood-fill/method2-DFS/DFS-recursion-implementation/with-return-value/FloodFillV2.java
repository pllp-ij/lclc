...
/*
    ...
    DESCRIPTION:
        ...
        Iterate each next direction with idxDirection from 0 to 3
            ...
            STEP 4
            If isValid(image, m, n, nextI, nextJ, oldColor, newColor, directions)            
                STEP 5
                Do DFS recursively
        ...
        the solution of whole problem is splitted into above five parts, so combined them together will get the final filled image state, then return that final state of image, and
        compared to V1, the parts from 2 to 5 will first checked, if that is valid then it will be processed
