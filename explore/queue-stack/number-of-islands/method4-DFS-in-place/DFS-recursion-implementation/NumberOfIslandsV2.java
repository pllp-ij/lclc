...
/*
    ...
    DESCRIPTION:
        ...
        Iterate each row of matrix with i
            ...
            Iterate each col of matrix with j
                STEP 4
                If matrix[i][j] == '1', (meaning current position is in lslandsNum)
                    STEP 5
        ...
        Iterate each direction with idxDirection from 0 to 3
            ...
            STEP 5
            If isInValidRegion(matrix, nextI, nextJ, m, n), (meaning next position is in valid)
                STEP 6
                Recursively do DFS
        ...
        If i >= 0 && i < m &&
           j >= 0 && j < n &&
           matrix[i][j] == '1', (meaning current position (i, j) is vlaid)
            STEP 2
            return true;
        STEP 3
        return false;
    ...
    SPACE:
        O(m * n), an extra calling stack is used in recursion
*/
