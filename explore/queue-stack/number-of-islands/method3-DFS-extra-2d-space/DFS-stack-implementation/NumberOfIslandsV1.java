    ...
    DESCRIPTION:
        ...
        Loop while !stack.isEmpty(), (when stack is not empty)
            ...
            Pop top node from stack and assign it to curNode
                curNode = stack.pop();
            STEP 6
            If isInInvalidRegion(matrix, curNode.i, curNode.j, m, n, visited), (meaning if current position(i, j) is not valid, corresponding to the recursion implemetation V1 solution, in which, a check on current node is done in STEP 1 and STEP 2)
                STEP 7
